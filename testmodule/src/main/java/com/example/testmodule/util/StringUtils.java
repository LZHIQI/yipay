...
public final class StringUtils {
    ...
    public static void text(TextView textView, final CharSequence s) {
    ...
    public static boolean isEmptyAnd0(final CharSequence s) {
        return s == null || s.length() == 0||s.equals("null")|s.equals("0");
    }
    /**
    ...
    public static String getString(final CharSequence s ) {
        try {
    ...
    public static String getEncryptionValue(String url, int width, int height) {
        ...
        return String.valueOf(Math.abs(hash(stringBuilder.hashCode())));
    }
    /**
     * hash
     *
    ...
    public static String rename(String fileName) {
        ...
        return temp + "_" + TimeUtils.getNowString() + suffix;
    }
