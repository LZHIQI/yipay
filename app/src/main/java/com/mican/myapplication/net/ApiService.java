...
public class ApiService {
     public static final String BASE_API_URL_FORMAL = "https://admin.utools.club/";//用户版API正式环境
     public static final String BASE_API_URL_TEST = "https://admin.utools.club/";//用户版API测试环境
