...
public final class ToastUtils {
    ...
    public static void showNoEmptyShort(final CharSequence text) {
        if((text == null))return;
    ...
    public static void showSuccess(String msg){
        ...
        ViewGroup resultView = (ViewGroup) showCustomShort(R.layout.operating_result);
        ConstraintLayout toastParent = resultView.findViewById(R.id.toast_parent);
        ...
        TextView toastHint = resultView.findViewById(R.id.toast_hint);
        toastHint.setText(msg);
        ImageView icToast = resultView.findViewById(R.id.ic_toast);
        icToast.setImageDrawable(ContextCompat.getDrawable(Utils.getApp(),R.drawable.toast_success));
        ToastUtils.clearGravity();
    }
    ...
    public static void showFail(String msg){
        ...
        toastHint.setText(msg);
        ImageView icToast = resultView.findViewById(R.id.ic_toast);
        icToast.setImageDrawable(ContextCompat.getDrawable(Utils.getApp(),R.drawable.toast_fail));
        ToastUtils.clearGravity();
    }
